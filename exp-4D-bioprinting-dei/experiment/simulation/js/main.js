...
(function () {
  ...
  function refresh() {
    ...
    const li = document.getElementById('liveInsight');
    if (li) {
      if (!tgOk) li.innerHTML = '<strong>⚠ Safety Contradiction:</strong> ' + S.name + ' has T_g = ' + S.Tg + ' °C. At body temp (37 °C) this is only ' + (37 - S.Tg) + ' °C from recovery — the stent could <strong>deploy prematurely during room-temperature handling/storage</strong>. Revise to an SMP with <strong>T_g = 45–50 °C</strong>.';
