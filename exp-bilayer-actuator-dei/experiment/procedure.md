...
Welcome to the 4D Printing Virtual Laboratory. This lab walks you through the mechanics of stimulus-responsive bilayer actuators — from the classic bimetal bending formula through anisotropic swelling, print-path programming, diffusion timescales, and finally the useful work an actuator can deliver. Work through the five sub-calculators in order.
...
7. **Advance:** Click the **&rsaquo;** arrow to move to Sub-Calc B.
