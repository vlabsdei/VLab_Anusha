...
(function() {
    ...
    function drawStressChart(E1, E2, h1, h2, y_na, kappa, eps_th1, eps_th2) {
        ...
        LabLegend.attach(stressChartCanvas, [
            { color: '#E2570F', text: 'Bending stress sigma(y)' },
            { color: '#94a3b8', dash: true, text: 'Layer interface' }
        ], 'tl');
    }
...
(function() {
    ...
    function drawStressChart(kx, epsActive_xx, h1, h2, E1, E2) {
        ...
        LabLegend.attach(stressChartCanvas, [
            { color: '#E2570F', text: 'Swelling stress sigma(y)' },
            { color: '#94a3b8', dash: true, text: 'Layer interface' }
        ], 'tl');
    }
    ...
    function renderHistoryPlot(material, passiveMaterial, deltaC, h1, h2, L, currentTheta) {
        ...
        LabLegend.attach(historyChartCanvas, [
            { color: '#E2570F', text: 'Bend angle vs fibre angle' },
            { color: '#1E40AF', dash: true, text: 'Twist angle vs fibre angle' }
        ], 'tr');
    }
