...
Welcome to the 4D-Printed Soft Robots Virtual Laboratory. This lab walks a soft actuator from a single pneumatic bend all the way to a closed-loop controlled finger. Each sub-calculator is gated: set your parameters first, press **Start Experiment** on the 3D viewport, then run the cycle. Follow the five procedures below.
...
6. **Advance:** click the **&rsaquo;** next arrow to Sub-Calc B.
...
3. **Start the experiment**, then click **Run Lock Cycle**. The finger pressurises, cools (colour shifts blue&rarr;dark as it stiffens), and releases.
...
6. **Advance:** click the **&rsaquo;** next arrow to Sub-Calc C.
...
7. **Advance:** click the **&rsaquo;** next arrow to Sub-Calc D.
...
7. **Advance:** click the **&rsaquo;** next arrow to Sub-Calc E.
