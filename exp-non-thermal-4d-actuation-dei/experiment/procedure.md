...
In this lab you drive printed active structures with light and magnetic fields instead of bulk heat, then measure how fast and how far each one responds. Work through the five sub-calculators below. Each opens behind a **Start Experiment** gate, so set your parameters first, then start the solver.
...
1. **Pick the light colour:** Choose **365 nm UV - makes it bend** or **450 nm visible - lets it relax**. UV switches the dye from trans to cis (bending); visible reverses it.
...
6. **Advance:** Use the next-step control at the bottom of the rail.
...
6. **Finish:** This is the last sub-calc.
